...
<head>
    ...
    <style>
        ...
        #memo .company-name {
            background: #487774 560px center no-repeat;
        ...
        #sums {
            float: right;
            background: #487774 -17px bottom no-repeat;
...
<div id="container">
    ...
    <section id="invoice-title-number">
        ...
        <span id="title">Facture numéro : </span>
    ...
    <section id="items">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr data-iterate="item" th:each="item, iterator : ${items}">
    ...
    <div class="payment-info">
        <div>Détails sur le payement:</div>
        <div>IBAN:[(${iban})]</div>
        <div>SWIFT:[(${swift})]</div>
    </div>
